<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="QuizEngine.ClassicWebForms.Pages.ManageUsers" Culture="auto" meta:resourcekey="PageResource2" UICulture="auto" %>
	...
	<div id="UserManagementPopup" style="display: none;">
        ...
        <div class="popupRow">
            <div class="labelColumn">
                <label id="lblUsername" for="txtUsername" class="label"></label><br />
				<label id="lblUsernameRestrictionMessage" class="commentlabel"></label>
            </div>
        ...
        <div class="popupRow">
            <div class="labelColumn">
                <label id="lblIsDomain" class="label"></label><br />
				<label id="lblUsernameCheckboxMessage" class="commentlabel"></label>
            </div>
            <div class="controlColumn">
