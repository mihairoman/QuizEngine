function ChoiceControl() {
    ...
    validateChocie = function (valid, choice) {

        $(".choicesection .choiceoptions").find("." + selectedValue).each(function () {
            if (valid) {
                $(this).find(".choicetext").removeClass("incorrectfield");
                if ($(this).find(".choiceselect")) {
                    $(this).find(".choiceselect").removeClass("incorrectfield");
                }
                if ($(this).find(".valuetext")) {
                    $(this).find(".valuetext").removeClass("incorrectfield");
                }
            }
            else {
                if ($(this).find(".choicetext").val() == choice.AnswerText) {
                    $(this).find(".choicetext").addClass("incorrectfield");
                    if ($(this).find(".choiceselect")) {
                        $(this).find(".choiceselect").addClass("incorrectfield");
                    }
                    if ($(this).find(".valuetext")) {
                        $(this).find(".valuetext").addClass("incorrectfield");
                    }
                }
            }
