...
function ValidateQuestion(selectedTags, choices, question, choiceControlObject) {
    var valid = true;
    ...
    for (i = 0; i < choices.length; i++) {
        if (question.QuestionType == QuestionType.TrueFalse) {
            if (choices[i] == null || choices[i] == undefined) {
                ...
                choiceControlObject.ValidateChoice(valid, choices[i]);
            }
            choiceControlObject.ValidateChoice(true, choices[i]);
        }
