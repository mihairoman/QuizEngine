...
namespace QuizEngine.ClassicWebForms.Webservices
{
    ...
    public class QuizViewListingService : BaseWebservice
    {
        ...
        /// <returns></returns>
        [WebMethod]
        public string ReadAllTemplateQuizes(string userID, string pageNumber=null,string quizTemplatePerPage=null,string sortExpression = null)
        {
            ...
            try
            {
                ...
                {
                    return _serializer.Serialize(_context.Objects.QuizTemplate.ReadAllQuizTemplateView(userGUID,pageNumberInter,quizTemplatePerPageInter,sortExpression));
                }
            }
            catch (Exception)
            {
            ...
            return _serializer.Serialize(_context.Objects.QuizTemplate.ReadAllQuizTemplateView(userGUID));
        }

        [WebMethod]
        public string CountAllTemplateQuizes(string userGuid)
        {
            Guid _userGuid = new Guid(userGuid);
            return _serializer.Serialize(_context.Objects.QuizTemplate.CountQuizTemplate(_userGuid));
        }
