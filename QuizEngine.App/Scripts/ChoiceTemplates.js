        ...
        return $('\
            <div class="Single popupRow" style="background-color: #F8F8F8;">\
                ...
                <div class="choicecontrolbtns choicebuttoncolumn">\
                    <a href="#"  class="add_choice_form"><img src="../Images/add.png" style="float: left; width: 42%; height: 90%; margin-right: 0.4em"></a>\
                    <a href="#"  class="remove_choice_form" ><img src="../Images/remove.png" style="float: left; width: 42%; height: 90%;"></a>\
                </div>\
          </div>\
        ');
    }
