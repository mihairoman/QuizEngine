$(document).ready(function () {
    ...
    req.ExecuteCall("QuizViewListingService.asmx", "AllUsersRead", "{}", AllUsersReadSuccess, AllUsersReadError);

    function AllUsersReadSuccess(response) {
        var response2 = JSON.parse(response);
        var jsonostr = response2.d; //in response I have the data from webservice
    ...
    function AllUsersReadError() {
        alert("Ajax error on AllUsersRead");
    }

    function GetQuizViewCountSuccess(response) {
        var response2 = JSON.parse(response);
        allRowCount = response2.d;
        quizPager.Reset();
        quizPager.Init(allRowCount, _rowPerPage, 'pager');
        getQuizView();
    }

    function GetQuizViewCountError() {
        alert("Ajax error!Can not read the number of quizes");
    }

    function GetQuizViewSuccess(response) {
        var response2 = JSON.parse(response);
        var jsonostr = response2.d; //in response I have the data from webservice
    ...
    function GetQuizViewError() {
        alert("Ajax error! Can not read quizView objects!");
    }
    ...
    function getQuizView() {
        ...
        _quizView = [];
        req.ExecuteCall("QuizViewListingService.asmx", "QuizViewRead", JSON.stringify(_quizViewInfo), GetQuizViewSuccess, GetQuizViewError); 
    };
    ...
    function getQuizViewCount() {
        ...
        req.ExecuteCall("QuizViewListingService.asmx", "CountAllQuizView", JSON.stringify(_userGuid), GetQuizViewCountSuccess, GetQuizViewCountError);
    };
