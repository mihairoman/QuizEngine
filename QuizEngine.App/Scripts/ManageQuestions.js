$(document).ready(function () {
    ...
    _tagSwapperObject.Init('tagswapper', 'QuestionFilteringService.asmx', 'GetAllTags');
    // used tor eturn the question type object
    var _questionTypeSwapperObject = new SwapperControl();
    _questionTypeSwapperObject.Init('questiontypeswapper', 'QuestionFilteringService.asmx', 'GetAllQuestionTypes');
    ...
    function BindEvents() {
        ...
        $('#questionContainer').off('click', '.questiondelete').on('click', '.questiondelete', function (event) {
            ...
            req.ExecuteCall("QuestionFilteringService.asmx", "DeleteQuestion", JSON.stringify(deleteQuestion), OnSuccessDeleteQuestion, OnErrorDeleteQuestion);
        });

        function OnSuccessDeleteQuestion(data) {
            PopulateTable();
        }
        function OnErrorDeleteQuestion(data) { }
    ...
    function PopulateTable() {
        if (document.getElementById("questionContainer").rows)
    ...
    function GetQuestionWithAjax() {
        var req = new PEService();
        req.ExecuteCall("QuestionFilteringService.asmx", "GetFilteredQuestions", JSON.stringify(_filterInfo), OnSuccessGetFilteredQuestions, OnErrorGetFilteredQuestions);
    }

    function OnSuccessGetFilteredQuestions(data)
    {
    ...
    function OnErrorGetFilteredQuestions(data)
    {
    }
    ...
    function CountFilteredQuestionsWithAjax() {
        ...
        var req = new PEService();
        req.ExecuteCall("QuestionFilteringService.asmx", "CountAllFilteredQuestions", JSON.stringify(countFilterInfo), OnSuccessCountAllFilteredQuestions, OnErrorCountAllFilteredQuestions);
    }

    function OnSuccessCountAllFilteredQuestions(data) {
        _filteredQuestionsCount = JSON.parse(data).d;
        _pagerObject.Reset();
        _pagerObject.Init(_filteredQuestionsCount, _rowsPerPage, _pagerForm);
    }

    function OnErrorCountAllFilteredQuestions(data)
    {
    }
