$(document).ready(function () {
        ...
        function AppendWithPermisions(userPermissions) {
        ...
        function MasterOnSuccess(response) {
            var jsonobj = JSON.parse(JSON.parse(response).d);
            AppendWithPermisions(jsonobj);

        }
        function MasteronError(response) {
        }
        ...
        function GetLinkPermissions() {
            ...
            req.ExecuteCall("LinkPermissionService.asmx", "GetLinkPermissions", JSON.stringify(x), MasterOnSuccess, MasteronError);
        }
