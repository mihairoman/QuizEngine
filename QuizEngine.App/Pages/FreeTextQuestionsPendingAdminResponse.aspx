...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <link href="/Content/FreeTextQuestionValidationWizard.css" rel="stylesheet" type="text/css" />
  ...
  <%--  <script src="//code.jquery.com/jquery-1.10.2.js"></script>
    ...
    <div id="Principal">
        <asp:Label cssclass="lblValidation" runat="server" Text="Free text questions validation" Font-Bold="True" Font-Size="Larger"></asp:Label>
